...
#include "PashaSimpleParticleComponent.h"
...
UPashaSimpleParticleComponent::UPashaSimpleParticleComponent()
{
...
void UPashaSimpleParticleComponent::BeginPlay()
{
    Super::BeginPlay();
...
void UPashaSimpleParticleComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UPashaSimpleParticleComponent::ConstrainAngles()
{
...
void UPashaSimpleParticleComponent::VerletIntegrate(float DeltaTime)
{
...
FVector UPashaSimpleParticleComponent::GetParticleCurrentLocation()
{
    return ParticleLocation;
}

bool UPashaSimpleParticleComponent::AttachComponentToParticle(USceneComponent* Parent, EAttachmentRule LocationRule, EAttachmentRule RotationRule, EAttachmentRule ScaleRule)
{
    const bool AttachResult = K2_AttachToComponent(Parent, TEXT("VirtualParticle"), LocationRule, RotationRule, ScaleRule, true);
    return AttachResult;
}

void UPashaSimpleParticleComponent::MoveAttachedToParticle()
{
...
void UPashaSimpleParticleComponent::SetAttachToParticleOffset(FTransform RelativeOffset)
{
    RelativeAttachOffset = RelativeOffset;
}

FQuat UPashaSimpleParticleComponent::FindBetweenNormals(FVector V1, FVector V2)
{
