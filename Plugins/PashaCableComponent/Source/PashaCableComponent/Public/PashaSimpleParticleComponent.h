...
#include "PashaSimpleParticleComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = (Physics), meta = (BlueprintSpawnableComponent, Thumbnail = "Resources/PashaSimpleParticleComponent_64x.png"))
class PASHACABLECOMPONENT_API UPashaSimpleParticleComponent : public UArrowComponent
{
    GENERATED_BODY()

public:
    UPashaSimpleParticleComponent();
