...
#include "PashaCablePhysic.generated.h"
...
struct FCableAttachPoint
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cable Attach")
	int ParticleIndex = 8;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cable Attach")
...
struct FExposedCableParticle
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cable Particle")
...
class PASHACABLECOMPONENT_API UPashaCablePhysic : public UMeshComponent
{
