...
void FPasha_LayerBlendingLogic::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
    ...
    RebuildAllBlendWeights(Context.AnimInstanceProxy->GetSkeleton());
...
void FPasha_LayerBlendingLogic::Evaluate_AnyThread(FPoseContext& Output)
{
    ...
    //Zaaplikowanie animacji Additive dla poszczeg?nych cz?ci szkieletu - przestrze?szkieletu
    ...
    //Zaaplikowanie animacji Additive dla poszczeg?nych cz?ci szkieletu - przestrze?lokalna
