...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Execute Sample function", Keywords = "Pasha"), Category = "Pasha_FunctionsLibrary")
	static float HelpfulFunctionsSampleFunction(float Param);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Character Capsule Start Location", Keywords = "Character Capsule Component"))
		static FVector GetPlayerCapsuleStartLocation(const UObject* WorldContextObject, const ACharacter* TargetChar);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Component", meta = (DisplayName = "Force Destroy Component", Keywords = "Component"))
		static void ForceDestroyComponent(UActorComponent* ActorComponent);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (DisplayName = "Elastic Out Interp (Vector)", Keywords = "Interpolation Vector"))
		static FVector ElasticOutInterpFast(FVector A, FVector B, float Alpha, float PowerBase=2);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (DisplayName = "Bounce Out Interp (Vector)", Keywords = "Interpolation Vector"))
		static FVector BouceOutInterpFast(FVector A, FVector B, float Alpha);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (DisplayName = "Get Angle Between Vectors", Keywords = "Vector Math Angle"))
		static float GetAngleBetween(FVector A, FVector B);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (DisplayName = "Slerp (Vector)", Keywords = "Vector Math Interpolation"))
		static FVector SlerpFast(FVector A, FVector B, float Alpha);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (DisplayName = "SlerpTo (Vector)", Keywords = "Vector Math Interpolation"))
		static FVector SlerpToFast(FVector Current, FVector Target, float DeltaTime, float InterpSpeed);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Capsule Have Room (With Ignore)", Keywords = "Character Trace"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Capsule Have Room (With Ignore) Transform", Keywords = "Character Trace"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| ClimbingSystem", meta = (WorldContext = "WorldContextObject", DisplayName = "Climbing Foot IK Trace V3", Keywords = "Character Trace IK Climbing"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (DisplayName = "Distance Point To Line", Keywords = "Vector Math Distance"))
		static float DistancePointToLine(FVector LineV1, FVector LineV2, FVector PointVector);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| ClimbingSystem", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Single Ledge Point", Keywords = "Character Trace Climbing"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (DisplayName = "N To F Vector (Yaw)", Keywords = "Vector Math Rotation"))
		static FVector NormalToVector(FVector Normal);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Array", meta = (DisplayName = "Check Is Not This Class", Keywords = "Actors Class Array"))
		static bool ClassToIgnore(UClass* Target,TArray<UClass*> ToIgnore);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| ClimbingSystem", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Single Ledge Point (Structure)", Keywords = "Character Trace Climbing"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| ClimbingSystem", meta = (WorldContext = "WorldContextObject", DisplayName = "Try Find Ledge Line", Keywords = "Climbing Trace Character"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| ClimbingSystem", meta = (WorldContext = "WorldContextObject", DisplayName = "Climbing - Ledge Valid P1", Keywords = "Climbing Validation Character"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Foot IK Offset", Keywords = "Foots IK Character", AutoCreateRefTerm="CurrentLocation"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (DisplayName = "Calculate Diagonal Scale Amount (Fast)", Keywords = "Movement Animations Character", BlueprintThreadSafe))
		static float CalculateDiagonalScale(UCurveFloat* Curve, FVelocityBlendCpp VelocityBlend);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Calculate Relative Acceleration Amount (Fast)", Keywords = "Movement Animations Character", BlueprintThreadSafe))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Calculate Velocity Blend Fast", Keywords = "Character AnimCurve", BlueprintThreadSafe))
		static FVelocityBlendCpp CalcVelocityBlendFast(const UObject* WorldContextObject, FVector Velocity);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Character", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Update Movement Values (AnimBP)", Keywords = "Character Anim Graph"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Update Aiming Values (AnimBP)", Keywords = "Character Anim Graph"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Character", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Update Movement Values LOD (AnimBP)", Keywords = "Character Anim Graph",
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Character", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Update Rotation Values (AnimBP)", Keywords = "Character Anim Graph",
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (WorldContext = "WorldContextObject", DisplayName = "Angle In Range", Keywords = "Float State Direction"))
		static bool AngleInRange(float Angle, float MinAngle, float MaxAngle, float Buffer, bool IncreaseBuffer);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Calculate Quadrant", Keywords = "Float State Direction", AdvancedDisplay = "FL_Threshold,BR_Threshold,FR_Threshold,BL_Threshold"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Smoothed Character Rotation", Keywords = "Character Rotation", AdvancedDisplay = "TargetInterpSpeedConst,TargetInterpSpeedSmooth,UpdateControl"))
	...
	// NOT WORKING!!!
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Trace", meta = (WorldContext = "WorldContextObject", DisplayName = "Rotated Capsule Trace By Channel", Keywords = "Trace Collision"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Trace", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Gap By Line Trace", Keywords = "Trace Collision", AutoCreateRefTerm = "ActorsToIgnore", AdvancedDisplay = "TraceColor,TraceHitColor,DrawTime,MaxIteracion"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Trace", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Gap By Sphere Trace", Keywords = "Trace Collision", AutoCreateRefTerm = "ActorsToIgnore", AdvancedDisplay = "bIgnoreSelf,TraceColor,TraceHitColor,DrawTime,MaxIteracion"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Trace", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Near Point To Wall Surface (Fast)", Keywords = "Trace CoverSystem Collision"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Array", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Near From Actors Array ", Keywords = "Array Actor"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Array", meta = (WorldContext = "WorldContextObject", DisplayName = "Class To Actors Array ", Keywords = "Array Actor"))
	...
	// The function's task is to add an offset to the target point so as to eliminate the collision with other AI controllers. It may happen that several controllers will reach to one point. This function tries to eliminate this situation.
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Navigation", meta = (WorldContext = "WorldContextObject", DisplayName = "Fix Move Point When Is Busy ", Keywords = "AI Navigation"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Collision", meta = (WorldContext = "WorldContextObject", DisplayName = "Check Room By Sphere Ray Cast ", Keywords = "Collision Nav"))
		static float RayCastSphereRoomCheckFast(UObject* WorldContextObject, FTransform Origin, float InRadius=80);
	// Working Only When Navigation System Is Valid
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Collision", meta = (WorldContext = "WorldContextObject", DisplayName = "Check Room By Sphere Complex Ray Cast ", Keywords = "Collision Nav"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Check Is Not Hiding In Foliage ", Keywords = "Character Trace"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Navigation", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Base Jump Away Position ", Keywords = "Navigation RayCast"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Math", meta = (WorldContext = "WorldContextObject", DisplayName = "FFT", Keywords = "Fast Fourier Transform"))
		static void FFT(TArray<float> Data, int32 NumSamples);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Math", meta = (WorldContext = "WorldContextObject", DisplayName = "Autocorrelation", Keywords = "Autocorrelation Function Array"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Interface", meta = (WorldContext = "WorldContextObject", DisplayName = "Execute Interface Input", CompactNodeTitle = "Inputs Interface", Keywords = "Inputs Interface"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (WorldContext = "WorldContextObject", DisplayName = "Cpp World To Local (Matrix)", Keywords = "Transform Convert"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (WorldContext = "WorldContextObject", DisplayName = "Cpp Local To World (Matrix)", Keywords = "Transform Convert"))
		static FCALS_ComponentAndTransform ConvertLocalToWorldFastMatrix(FCALS_ComponentAndTransform Local);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Math", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Get Safe Float Value", Keywords = "Curves"))
		static float GetSafeFloatValue(UCurveFloat* FloatCurve, float Time);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Animation", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Anim Slot Is Activated ", Keywords = "Animation Instance"))
		static bool AnimSlotIsActivated(UObject* WorldContextObject, FName SlotName);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Animation", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Anim Slot Is Activated By Target ", Keywords = "Animation Instance"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Is Enemy Value", Keywords = "Character AI"))
		static bool GetIsEnemyState(UObject* WorldContextObject, AActor* Checker = nullptr, AActor* ActorToCheck = nullptr);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Collision", meta = (WorldContext = "WorldContextObject", DisplayName = "Find Nearest Collision By Cylinder", Keywords = "Collision"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Animation", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Anim Curve Value At Time", Keywords = "Animations"))
		static float GetCurveValueAtTime(UObject* WorldContextObject, UAnimSequence* AnimSequence, FName CurveName, float Time);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Animation", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Root Motion Curve Value At Time", Keywords = "Animations"))
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Math", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject"))
		static FVector VInterpToWithDelay(const FVector& Current, const FVector& Target, float DeltaTime, float InterpSpeed);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Animation", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Bone Transform At Time", Keywords = "Animations"))
	...
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Animation", meta = (WorldContext = "WorldContextObject", DisplayName = "Get Anim Sequence From Montage", Keywords = "Animations"))
	static UAnimSequence* GetAnimSequenceFromMontage(const UAnimMontage* TargetAnimMontage, int SequenceIndex);

	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Collision", meta = (WorldContext = "WorldContextObject", DisplayName = "Check Floor Type By Trace", Keywords = "Collision", 
	...
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Actor", meta = (WorldContext = "WorldContextObject", Keywords = "Actor,Save"))
	static void TryMarkPackageDirty(UObject* WorldContextObject, AActor* Target);

	// Allows you to create a permanent component for a specific actor.
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Actor", meta = (WorldContext = "WorldContextObject", Keywords = "Actor,Component,Arrow"))
	static UActorComponent* CreateComponentAndAddToActor(AActor* TargetActor, TSubclassOf<UActorComponent> ComponentClass, FTransform RelativeTransform, FName ComponentName = NAME_None);


	
	UFUNCTION(BlueprintCallable, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (Keywords = "Math,Interpolation,Points"))
	static FVector InterpolateBetweenPoints(const TArray<FVector>& Points, float Alpha);


	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (Keywords = "Math,Character,Time,Distance"))
	static float EstimateTravelTime(
		float Distance = 100.0,
		float MaxWalkSpeed = 500.0,
		float MaxAcceleration = 2000.0,
		float BrakingDeceleration = 2000.0,
		bool bUseSeparateBrakingFriction = true,
		float BrakingFriction = 0.0,
		float GroundFriction = 8.0,
		float BrakingFrictionFactor = 0.3,
		bool bIncludeAcceleration = true,
		bool bIncludeDeceleration = true
	);

private:
	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Interpolation", meta = (DisplayName = "Bounce Out Time Function", Keywords = "Interpolation Vector"))
		static float BounceOutTimeFunction(float time);

	UFUNCTION(BlueprintPure, Category = "Pasha_FunctionsLibrary| Character", meta = (BlueprintThreadSafe, WorldContext = "WorldContextObject", DisplayName = "Get Anim Curve Value Clamped", Keywords = "Character AnimCurve"))
