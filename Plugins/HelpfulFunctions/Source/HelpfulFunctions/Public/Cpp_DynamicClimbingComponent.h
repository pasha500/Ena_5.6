...
protected:
	...
	UPROPERTY(BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "New Climbing System|Base"))
	float dt = 0.01;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "True", Category = "New Climbing System|Config", DisplayName = "Require Modify Volume For Ledge Detection"))
		bool bRequireModifyVolumeForLedgeDetection = true;
