...
class IWALS_ABILITYSYSTEM_API UIWALS_AnimInstanceCpp : public UAnimInstance
{
	...
	/* Zdefiniuj podstawowe zmienne, kt�re b�d� potrzebne dla systemu Overlay States. �eby nie odwo�ywa� si� do klasy ALS_AnimBP przy pomocy Property Access utworzony zosta� w�a�nie
	Anim Instance. W nim zdefiniowane s� potrzebne zmienne, wi�c dzi�ki temu odwo�ywa� si� b�dziemy w�a�nie do tej klasy a nie ca�ego ALS_AnimBP */
